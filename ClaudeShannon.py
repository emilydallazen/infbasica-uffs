...
def doutorado():
    mensagem = "Claude Elwood Shannon nasceu nos USA em 1916. Formou-se em Matemática e Engenharia Elétrica na Universidade de Michigan, e fez seu mestrado e doutorado no MIT."
    return mensagem
